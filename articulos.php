	...
	<section id="content">
      ...
      $categorias=$row1['categoria'];
			...
			?>			
					...
					<div id="boligrafos-plastico" class="span12"><h2 style="border-bottom: 1px solid #111111;"><a href="index.php">INICIO</a> <spam style="color: #FE0000"> > </spam><?php echo html_entity_decode($categorias,ENT_QUOTES);?></h2><div style="color: #999;"></p></div></div>
			...
			?>							<div class="span3">
									...
									<div class="product-list-item" id="bol-01-16-jeringa" style="height: 397px;">
										...
										<div class="image">
											...
											<span class="hidden">5</span><a href="detalle.php?id=<?php echo $id_articulo;?>&h=<?php echo $hora;?>&f=<?php echo $fecha;?>&us=<?php echo $us;?>&idcat=<?php echo $id;?>&cc=<?php echo $cc;?>" data-id="5">
