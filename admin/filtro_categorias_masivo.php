...
<?	
   ...
   body();?>
		...
		while($row=mysql_fetch_array($resultado)){
         ...
         <td><input type="submit" class="btn btn-success" onClick="this.form.action='actualizar_categoria.php';this.form.submit()" name="guardar" id="guardar" value="Agregar Categorias"></td>

         <td><input type="submit" class="btn btn-success" onClick="this.form.action='revertir_categorias.php';this.form.submit()" name="guardar" id="guardar" value="Revertir Asignación"></td>
