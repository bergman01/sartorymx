...
<?php body();?>
   <div id="page-wrapper">
    ...
    <div class="row">
          <div class="col-lg-10">
            <div class="row">
              <div class="col-md-6"><h1>Visitantes</h1></div>

              <form action="eliminar_usuarios2.php" method="post">
              <div class="col-md-6" align="right"><h2><a href="admin.si.usuarios.php?opc=ADD&id=0" class="btn btn-success">Agregar Usuario visitante</a> <span><input type="submit" class="btn btn-primary" value="Eliminar Seleccion"></span> <a href="exporta_visitantes.php" class="btn btn-success">Exporta visitantes</a></h2></div>
            </div>
              ...
              if(mysql_num_rows($resultado)>0){
                ...
                ?>
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    ...
                    <?php }?>
                    <td><a href="convierte_cliente.php?id=<?php echo $row['id'];?>"><i class="fa fa-address-card"></i>Convertir a Cliente</a></td>
