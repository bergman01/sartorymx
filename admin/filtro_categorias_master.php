		...
		<div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xs-14">
            <div class="row">
              ...
              <div class="col-sm-4 col-md-6 col-lg-10 col-xs-2" align="right"><h2><a href="admin.si.mega.categorias.php?opc=ADD&id=0" class="btn btn-success">Agregar Division</a></h2></div>
            </div>
