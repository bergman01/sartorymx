...
<?	
   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-sm-14 col-md-6 col-lg-10 col-xs-14">



            <h2 style="color:#FE0000;text-align: left;">ADMINISTRADOR DE PERSONALIZACIONES</h2>
		...
		<div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xs-14">
            ...
            <div class="row">
  	          ...
  	          <div class="col-sm-8 col-md-6 col-lg-2 col-xs-6"><h1>Personalización</h1></div>
		...
		while($row=mysql_fetch_array($resultado)){
			...
			$visible=$row[0];
  	          ...
  	          <div class="col-sm-4 col-md-6 col-lg-10 col-xs-2" align="right"><h2><a href="per.php?id=<?php echo $visible;?>" class="btn btn-success">Publicar | Despublicar</a> <a href="admin.si.personalizacion.php?opc=ADD&id=0" class="btn btn-success">Agregar Perzonalizado</a></h2></div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <thead>
                  ...
                  <tr><td style="background-color: #0A0145;color: #ffffff;"><input type="checkbox" id="marcar" onclick="marcar_desmarcar();" value=""></td>
