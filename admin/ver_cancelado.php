...
<h2 class="title-step">Precios de Personalizados y Descuentos</h2>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?php
                            ...
                            $codigo_cotizacion = $_GET['cc'];
                                 ...
                                 $query2="Select * from cotizacion where usuario='$usuario' and estatus=6 and fecha='$fecha' and hora='$hora' limit 1;";
							...
							$query="Select * from cotizacion where usuario='$usuario' and estatus=6 and fecha='$fecha' and hora='$hora';";
                  ...
                  <input type="hidden" name="codigo_cotizacion" value="<?php echo $codigo_cotizacion;?>">
					...
					<td><span class="add-on">$ </span><?php echo ROUND($row['precio_venta'],2);?></td>
              ...
              ?>
                            ...
                            <table class="table table-bordered table-hover table-striped tablesorter">
                            	...
                            	<td><select class="form-control" name="motivo" class="required">
                                     <option value="">Seleccionar motivo</option>
      <?php
    $query="SELECT id_motivo,motivo FROM motivo_cancelacion order by motivo asc";
    ...
    while($row=mysql_fetch_array($resultado)){
      ...
      ?>
       <option  value="<? echo $row[0]; ?>" <?php if ($motivo==$row[0]) { echo 'checked="checked"'; } ?>> <?php echo $row[1] ?> </option>
         <?php } ?>
         </select>
                            </td>
                            </tr>
                            <tr>
                            	<td>Observaciones</td>
                            	<td><textarea name="observaciones"><?php echo html_entity_decode($obser,ENT_QUOTES);?></textarea></td>
                            </tr>
                        </table>
                            <table>
                            <tr>
                            	<td><a href="filtro_cancelaciones.php" class="btn btn-success" style="background-color: rgb(71, 164, 71);;border-color: rgb(71, 164, 71);">Regresar</a>&nbsp;&nbsp;&nbsp;</td>
