   ...
   <div id="page-wrapper">
		...
		while($row=mysql_fetch_array($resultado)){
			...
			$visible=$row[0];
              ...
              <div class="col-md-6" align="left" style="margin-left: 10px;"><h2><a href="precios.php?id=<?php echo $visible;?>" class="btn btn-success">Publicar | Despublicar Precios</a> <a href="admin.si.articulos.php?opc=ADD&id=0" class="btn btn-danger">Agregar Articulo</a> </h2></div>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
                  ...
                  <td><input type="checkbox" name="seleccion[]" value="<?php echo $row['id_articulo']; ?>" requerit><?php echo $row['id_articulo']; ?></td>
                    ...
                    <form name="form" method="post" action="actuaizar_costo.php">
                    <input type="hidden" name="id_articulo" value="<?php echo $row['id_articulo']; ?>">
                    <input type="hidden" name="utilidad[]" value="<?php echo $row['utilidad']; ?>">
                    <td><input type="text" name="costos[]" value="<? echo round($row['costos'], 2); ?>" style="width: 50px;"></td>
