   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-sm-8 col-md-6 col-lg-10 col-xs-14">
           ...
           <h2 style="color:#FE0000;text-align: left;">ADMINISTRADOR DE PROVEEDORES</h2>
		...
		<div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xs-14">
            ...
            <div class="row">
  	          ...
  	          <div class="col-sm-8 col-md-6 col-lg-2 col-xs-6"><h1>Proveedores</h1></div>



              <div class="col-sm-4 col-md-6 col-lg-10 col-xs-2" align="right"><h2><a href="admin.si.proveedores.php?opc=ADD&id=0" class="btn btn-success">Agregar Proveedor</a></h2></div>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="background-color: #0A0145;color: #ffffff;">Detalles Proveedor</th>
                ...
                <?
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    ...
                    <td><a href="javascript:window.open('detalles_proveedor.php?id=<?php echo $row['id_proveedor'];?>&opc=UPD','','width=800,left=50,top=50,toolbar=yes');void 0" target="_blank">Detalles Proveedor</a></td>
