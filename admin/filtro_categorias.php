   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-sm-8 col-md-6 col-lg-12 col-xs-14">
            ...
            <h2 style="color:#FE0000;text-align: left;">ADMINISTRADOR DE CATEGORIAS</h2>
		...
		<div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xs-14">
            ...
            <div class="row">
  	          ...
  	          <div class="col-sm-8 col-md-6 col-lg-2 col-xs-6"><h1>Categorias</h1></div>
              ...
              <div class="col-sm-4 col-md-6 col-lg-10 col-xs-2" align="right"><h2><a href="admin.si.categorias.php?opc=ADD&id=0" class="btn btn-success">Agregar Categoria</a></h2></div>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    ...
                    <td><a href="../categorias/<?php echo $row['imagen']?>" target="_blank" border="0" /><? echo html_entity_decode($row['categoria'], ENT_QUOTES); ?></a></td>
