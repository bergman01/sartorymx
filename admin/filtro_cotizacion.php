              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                  <tr>
                    ...
                    <th style="width: 50px">Cancelacion</th>
                    <th>PDF</th>
                    <th style="width: 50px"></th>
                  </tr>
                </thead>
                ...
                <?php
							...
							$query="SELECT DISTINCT usuario,fecha,estatus,hora,empresa2,destinatario,contacto_empresa,empresa,cotizado_por,envio,codigo_cotizacion FROM cotizacion where estatus=2 order by fecha desc,hora desc;";
                  ...
                  <td><?php echo $row['codigo_cotizacion'];?></td>
                    ...
                    <td><input style="width: 250px !important;" type="text" name="cliente" value="<?php echo $row['empresa2'] ?>" /></td>
                    <td><input style="width: 250px !important;" type="text" name="cotizado_por" value="<?php echo $row['destinatario']; ?>" /></td>
                    ...
                    <td><a href="convertir_venta.php?codigo=<?php echo $row['codigo_cotizacion'];?>" onclick="return confirmar('¿Está seguro que desea convertir a venta esta cotización?')"> <img src="img/report_edit.png" border="0" title="Convertir Venta" style="cursor: pointer;">Venta</td>
                    	<td><a href="convertir_cancelado.php?codigo=<?php echo $row['codigo_cotizacion'];?>" onclick="return confirmar('¿Está seguro que desea cancelar esta cotización?')"> <img src="img/report_edit.png" border="0" title="Convertir Venta" style="cursor: pointer;">Cancelado</td>
