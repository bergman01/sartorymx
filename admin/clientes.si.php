...
$codigo=generaPass();
 ...
 //echo $v;   
	...
	if($opcion=='UPD'){
		...
		$query="SELECT destinatario,empresa,contacto_empresa,email,celular,nota,nombres,apellidos,extension,telefono_empresa from clientes where id_clientes='$idreg' limit 1";
		...
		if($opcion=='SAVE'){
			...
			if(!empty($_FILES['filefoto']['name'])){
				...
				if(move_uploaded_file($_FILES['filefoto']['tmp_name'], $target_path)) {
					...
					if($idreg!=0){
						...
						//echo $foto;
						 ...
						 $tranx="update clientes set destinatario='$destinatario',empresa='$empresa',contacto_empresa='$contacto_empresa',email='$email_empresa',celular='$celular_empresa',nota='$nota',nombres='$nombres',apellidos='$apellidos',telefono_empresa='$telefono_empresa',extension='$extension' where id_clientes =$idreg";
						...
						$tranx="insert into clientes(destinatario,empresa,contacto_empresa,email,celular,nota,nombres,apellidos,telefono_empresa,extension) values('$destinatario','$empresa','$contacto_empresa','$email_empresa','$celular_empresa','$nota','$nombres','$apellidos','$telefono_empresa','$extension');";
				...
				if($idreg!=0){
					...
					$tranx="insert into clientes(destinatario,empresa,contacto_empresa,email,celular,created_by,created_date,nota,nombres,apellidos,telefono_empresa,extension) values('$destinatario','$empresa','$contacto_empresa','$email_empresa','$celular_empresa','$user',NOW(),'$nota','$nombres','$apellidos','$telefono_empresa','$extension');";
...
informacion. Por favor Intenta de Nuevo.</div>
    ...
    <div class="modal-footer">
                    ...
                    <a href="javascript:window.history.go(-1);" onclick="return confirmar('¿Est&aacute; seguro que desea salir,no se guardara el registro?')"><button type="button" class="btn btn-default" data-dismiss="modal" >Cancelar</button></a>
