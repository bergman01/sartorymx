...
<?php
   body();?>
          ...
          <div class="col-sm-8 col-md-6 col-lg-12 col-xs-14">
            <h2 style="color:#FE0000;text-align: left;">ADMINISTRADOR DE CATEGORIAS MULTIPLES</h2>
          </div>
		...
		$query="SELECT * FROM mega_categorias where mega_categoria_estatus = 1";
		...
		while($row=mysql_fetch_array($resultado)){
         ...
         <td><input type="submit" class="btn btn-success" onClick="this.form.action='actualizar_megacategoria.php';this.form.submit()" name="guardar" id="guardar" value="Agregar Mega Categorias"></td>

         <td><input type="submit" class="btn btn-success" onClick="this.form.action='revertir_megacategoria.php';this.form.submit()" name="guardar" id="guardar" value="Revertir Asignación"></td>
              ...
              <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                ...
                <thead>
                  ...
                  <tr>
                  	...
                  	<td style="background-color: #0A0145;color: #ffffff;"><input type="checkbox" id="marcar2" onclick="selecto();" value=""></td>
                    ...
                    <th style="background-color: #0A0145;color: #ffffff;">MegaCategoria</th>

                    <th style="background-color: #0A0145;color: #ffffff;">Proveedor</th>

                    <th style="background-color: #0A0145;color: #ffffff;">Precio Venta</th>
                ...
                <?
							...
							if($codigo != '' && $proveedor != ''){
								...
								$query="SELECT a.id_articulo,a.precio_publicado,a.codigo,a.precio_venta,a.estatus,a.categoria,a.nombre,a.personalizado,p.id_proveedor,p.nombre as proveedor,c.id_categoria,c.categoria,a.categoria as idcat,a.mega_categoria as idmcat FROM articulos a, proveedores p,categorias c where a.codigo like '%$codigo%' and a.id_proveedor = $proveedor and a.id_proveedor = p.id_proveedor and a.categoria=c.id_categoria and a.estatus = 1 order by a.id_articulo Asc;";
							...
							if($codigo != '' && $categoria != ''){
								...
								$query="SELECT a.id_articulo,a.precio_publicado,a.codigo,a.precio_venta,a.estatus,a.categoria,a.nombre,a.personalizado,p.id_proveedor,p.nombre as proveedor,c.id_categoria,c.categoria,a.categoria as idcat,a.mega_categoria as idmcat FROM articulos a, proveedores p,categorias c where a.codigo like '%$codigo%' and FIND_IN_SET('$categoria', a.categoria) and a.id_proveedor = p.id_proveedor and a.categoria=c.id_categoria and a.estatus = 1 order by a.id_articulo Asc;";
							...
							if($palabra != '' && $categoria != ''){
								...
								$query="SELECT a.id_articulo,a.precio_publicado,a.codigo,a.precio_venta,a.estatus,a.categoria,a.nombre,a.personalizado,p.id_proveedor,p.nombre as proveedor,c.id_categoria,c.categoria,a.categoria as idcat,a.mega_categoria as idmcat FROM articulos a, proveedores p,categorias c where a.nombre like '%$palabra%' and FIND_IN_SET('$categoria', a.categoria) and a.id_proveedor = p.id_proveedor and a.categoria=c.id_categoria and a.estatus = 1 order by a.id_articulo Asc;";
							...
							if($proveedor != '' && $precio != ''){
								...
								$query="SELECT a.id_articulo,a.precio_publicado,a.codigo,a.precio_venta,a.estatus,a.categoria,a.categoria as idcat,a.mega_categoria as idmcat,a.nombre,a.agotado,p.id_proveedor,p.nombre as proveedor,c.id_categoria,c.categoria FROM articulos a, proveedores p,categorias c where a.id_proveedor = $proveedor and a.precio_venta <= round('$precio', 2) and a.id_proveedor = p.id_proveedor and a.categoria=c.id_categoria and a.estatus = 1 order by a.id_articulo Asc;";
							}
						...
						if($codigo != '' && $precio != ''){
							 $query="SELECT a.id_articulo,a.precio_publicado,a.codigo,a.precio_venta,a.estatus,a.categoria,a.categoria as idcat,a.mega_categoria as idmcat,a.nombre,a.agotado,p.id_proveedor,p.nombre as proveedor,c.id_categoria,c.categoria FROM articulos a, proveedores p,categorias c where a.codigo like '%$codigo%' and a.precio_venta <= round('$precio', 2) and a.id_proveedor = p.id_proveedor and a.categoria=c.id_categoria and a.estatus = 1 order by a.id_articulo Asc;";
                  ...
                  <td><input type="checkbox" name="seleccion[]" value="<?php echo $row['id_articulo']; ?>" requerit><?php echo $row['id_articulo']; ?></td>
					...
					<td><?php  $query2="select * from mega_categorias where mega_categoria_id in(".$row['idmcat'].");";
