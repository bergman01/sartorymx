   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-sm-8 col-md-6 col-lg-10 col-xs-14">
            ...
            <h2 style="color:#FE0000;text-align: left;">ADMINISTRADOR DE BANNERS POR DIVISIONES</h2>
		...
		<div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xs-14">
            ...
            <div class="row">
  	          ...
  	          <div class="col-sm-8 col-md-6 col-lg-2 col-xs-6"><h1>Banners por Division</h1></div>



              <div class="col-sm-4 col-md-6 col-lg-10 col-xs-2" align="right"><h2><a href="admin.si.banners.divisiones.php?opc=ADD&id=0" class="btn btn-success">Agregar Banner</a></h2></div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                  ...
                  <tr>
                  	<th style="background-color: #0A0145;color: #ffffff;width: 50px;"></th>

                    <th style="background-color: #0A0145;color: #ffffff;">Nombre</th>
                    <th style="background-color: #0A0145;color: #ffffff;">Division</th>
                    ...
                    <th style="background-color: #0A0145;color: #ffffff;">Orden</th>
                ...
                <?
							...
							$query="SELECT * FROM banners_division order by id_banner desc;";
							...
							if(mysql_num_rows($resultado)>0){
								...
								<form action="agregar_ordenbaner_division.php" method="post">
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    ...
                    <td><a href="admin.si.banners.divisiones.php?<? echo "id=".$row['id_banner']."&opc=UPD"; ?>&rowId=row<? echo $icont; ?>"><img src="img/editar.gif" border="0"/></a></td>



                    <td><? echo html_entity_decode($row['nombre'], ENT_QUOTES); ?></td>
                    <td><?php 
                    $querys="SELECT * FROM divisiones where division_id = $id_division;";
							$resultados=mysql_query($querys, $link);
						while($rows = mysql_fetch_array($resultados)){
													echo $rows['division_nombre'];}
                    ...
                    <td><a href="eliminar_banners.division.php?id=<?php echo $row['id_banner']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="img/delete.gif" border="0"  title="Eliminar Seccion"  style="cursor:pointer;"  /></a></td>
