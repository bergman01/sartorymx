...
$cn = mysql_connect ("45.40.164.16","sartory","S4rT0rY#") or die ("ERROR EN LA CONEXION");
...
$idArticulo=$objPHPExcel->getActiveSheet()->getCell("B".$i)->getCalculatedValue();

$nombre=$objPHPExcel->getActiveSheet()->getCell("C".$i)->getCalculatedValue();

$imagen=$objPHPExcel->getActiveSheet()->getCell("D".$i)->getCalculatedValue();
...
$c=("update articulos set imagen='$imagen' where id_articulo=$idArticulo;");
