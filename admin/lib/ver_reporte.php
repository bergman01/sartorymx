		...
		<div class="row">
         ...
         while($row9=mysql_fetch_array($resultado9)){
          ...
          $puesto = $row9['puesto'];
            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
            <input type="hidden" name="destinatario" id="destinatario2" value="<?php echo $nombre_usuario.' '.$apellido_usuario;?>">
            <input type="hidden" name="id_cliente" id="id_cliente" value="">
                            ...
                            <tr><td>Nota: </td><td><input type="text" name="nota" value="Se aplican restricciones. Precios sujetos a cambios sin previo aviso." style="width: 100%"></td></tr>
            				      ...
            				      <a href="filtro_cotizacion.php" class="btn btn-flat">Atras</a>
