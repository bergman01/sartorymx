...
$codigo='';
	...
	if($opcion=='UPD'){
		...
		$query="SELECT tag,estatus FROM tags where idtag='$idreg' limit 1";
				...
				if(move_uploaded_file($_FILES['filefoto']['tmp_name'], $target_path)) {
					...
					if($idreg!=0){
						...
						//echo $foto;
						 ...
						 $tranx="update tags set tag='$titulo',estatus=$publicar where idtag=$idreg";
						...
						$tranx="insert into tags (tag,estatus)  values('$titulo',$publicar";
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="row">
  	          ...
  	          <div class="col-md-6"><h2>Nuevo Tag</h2></div>
...
informaci&oacute;n. <a href="filtro_tag.php" onClick="actualizarLista();">Ver lista 
...
informacion. Por favor Intenta de Nuevo.</div>
    ...
    <div class="table-responsive">
        ...
        <tr>
            ...
            <td><input class="form-control" placeholder="Tag" type="text" id="nombre" name="nombre" value="<?php echo $titulo; ?>"/></td>
    ...
    <div class="modal-footer">
                    ...
                    <a href="filtro_tag.php" onclick="return confirmar('¿Est&aacute; seguro que desea salir,no se guardara el registro?')"><button type="button" class="btn btn-default" data-dismiss="modal" >Cancelar</button></a>
